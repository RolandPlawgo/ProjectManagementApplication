...
namespace ProjectManagementApplication.Services.Interfaces
{
    public interface IProjectsService
    {
        ...
        public Task<Result> UpdateProjectAsync(EditProjectRequest editProjectRequest);
        public Task<Result> CreateProjectAsync(CreateProjectRequest createProjectRequest);
